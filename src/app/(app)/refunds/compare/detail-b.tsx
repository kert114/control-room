...
import { DecideB } from "@/app/(app)/refunds/compare/decide-b";
...
import { buildRefundsHref, REFUNDS_COMPARE_PATH, type ListParams } from "@/modules/refunds/params";
import type { RefundDetail, RefundListItem } from "@/modules/refunds/queries";

export function RefundDetailPanelB({
  detail,
  params,
  actor,
  missing,
        ...
        <div className="flex flex-col gap-3">
          ...
          <DecideB
            ...
            nextHref={
              nextOpen
                ? buildRefundsHref(
                    { ...params, refund: nextOpen.id, step: 2 },
                    REFUNDS_COMPARE_PATH,
                  )
                : null
            }
            nextReference={nextOpen?.reference ?? null}
            queueHref={buildRefundsHref(
              { ...params, refund: undefined, step: 1 },
              REFUNDS_COMPARE_PATH,
            )}
          />
          <div>
